...
public final class DeviceRegistry extends Observable {
 ...
 /* public Set<Long> getPowerDomains() {
   ...
   * 
   * Note that this code records Format 2 canned.dat files, and requires a recent PixelPusher firmware.
   * 
   * @param filename
   * @param group
   * @param pusher
  ...
  /**
   * Get the elapsed time since the PixelPusher @param p has been seen most recently.
   * 
   * @param p
   * @return
   */
